...
filename = os.path.join('sample_imgs/misto.jpeg')
...
# cv2.imshow("",mark_boundaries(image, im_true))
###############################################################################
...
edges = sobel(image)
im_test1 = watershed(edges, markers=100, compactness=0.001)
#cv2.imshow("",mark_boundaries(image, im_test1))
###############################################################################
...
image_label_overlay = label2rgb(im_test3, image=image)
